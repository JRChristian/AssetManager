...
namespace AssetManager.Tests.Sessions
{
    public abstract class AssetManagerTestBase : AbpIntegratedTestBase
    {
        protected AssetManagerTestBase()
        {
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<AssetManagerApplicationModule>();
            modules.Add<AssetManagerDataModule>();
        }

        public void UsingDbContext(Action<AssetManagerDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<AssetManagerDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<AssetManagerDbContext, T> func)
        {
            T result;
