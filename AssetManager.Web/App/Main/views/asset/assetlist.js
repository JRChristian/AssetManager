                ...
                columnDefs: [
                    {
                        ...
                        cellTemplate: '<div class="ui-grid-cell-contents"><div class="btn-group btn-group-xs"><a class="btn btn-default" ui-sref="assetedit({ assetId: row.entity.id })"><i class="fa fa-pencil-square-o"></i></a> <a class="btn btn-default" ui-sref="assetlimitview({ assetId: row.entity.id })"><i class="fa fa-bar-chart"></i></a></div></div>'
                    },
