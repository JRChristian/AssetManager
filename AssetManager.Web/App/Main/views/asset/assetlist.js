                ...
                columnDefs: [
                    {
                        ...
                        cellTemplate: '<div class="ui-grid-cell-contents"><div class="btn-group btn-group-xs"><a class="btn btn-primary" ui-sref="assetedit({ assetId: row.entity.id })"><i class="fa fa-pencil-square-o"></i></a></div></div>'
                    },
